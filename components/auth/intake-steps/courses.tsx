...
export function Courses({ formData, updateFormData }) {
  ...
  }, [courses, updateFormData, isInitialRender])
  ...
  const addCourse = () => {
    setCourses([...courses, { subject: "", gradeLevel: "", hasPlatform: false, platform: "", notes: "" }])
  }
